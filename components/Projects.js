          ...
          {missions.map((project, i) => (
            <div key={i} className="min-w-screen h-screen flex items-center justify-center px-4 md:px-16">
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4 md:mb-6 relative z-10">
                  ...
                  <div className="flex items-center gap-3">
                    {project.isOpenSource && (
                      <span className="px-3 py-1 bg-green-500/10 border border-green-500/40 font-mono text-xs text-green-400">
                        OPEN SOURCE
                      </span>
                    )}
                ...
                <h3 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6 group-hover:text-orange-500 transition-colors font-mono relative z-10">
                  {project.title}
                </h3>
                <p className="text-sm md:text-lg text-gray-400 leading-relaxed mb-6 md:mb-8 font-mono relative z-10">
                  {project.desc}
                </p>
                ...
                <div className="flex flex-col gap-4 relative z-10">
                  <div className="flex gap-2 md:gap-3 flex-wrap">
                    {project.tech.map((t, j) => (
                      <span key={j} className="px-3 md:px-4 py-1 md:py-2 border border-orange-500/50 text-orange-500 text-xs md:text-sm font-mono bg-orange-500/5">
                        {t}
                      </span>
                    ))}
                  </div>
                    ...
                    <div className="flex gap-3">
                      {project.link && (
                        <a
                          ...
                          className="interactive flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-orange-500/50 hover:bg-orange-500/20 hover:border-orange-500 transition-all font-mono text-xs text-orange-500"
                        >
                      ...
                      {project.repo && (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="interactive flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all font-mono text-xs text-gray-400"
                        >
                          <Github size={12} />
                          SOURCE
                        </a>
            ...
            >
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center gap-2">
                  {project.isOpenSource && (
                    <span className="px-2 py-1 bg-green-500/10 border border-green-500/40 font-mono text-[10px] text-green-400">
                      OPEN SOURCE
                    </span>
                  )}
